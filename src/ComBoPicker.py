...
class Picker(ttk.Frame):
    ...
    def __init__(self, master=None, activebackground='#b1dcfb', values=None, entry_wid=None, activeforeground='black',
        ...
        for _index, _item in enumerate(self._values):
            ...
            self.dict_checkbutton[_item].bind("<")
...
class Combopicker(ttk.Entry, Picker):
    ...
    def __init__(self, master, values=None, entryvar=None, entrywidth=None, entrystyle=None, onselect=None, state="normal",
        ...
        ttk.Entry.__init__(
            self, master, textvariable=self.show_var, state=state, **entry_config)
    ...
    def hide_picker(self):
        if self._is_menuoptions_visible:
            ...
            self.event_generate('<<PickerHide>>')
